...
class ResizablePageLocators:
    ...
    BIG_BOX_RESIZE_BUTTON = (By.CSS_SELECTOR,
                             "div[id='resizableBoxWithRestriction'] span[class='react-resizable-handle "
                             "react-resizable-handle-se']")
    SMALL_BOX = (By.CSS_SELECTOR, "div[id='resizable']")
    SMALL_BOX_RESIZE_BUTTON = (
...
class DroppablePageLocators:
    ...
    DROP_HERE_SIMPLE = (By.CSS_SELECTOR, "div[id='droppable']")
    DROPPED_TEXT = (By.CSS_SELECTOR, "div[id='droppable'] p")
    ...
    DROP_HERE_ACCEPT = (By.CSS_SELECTOR, "div[id='droppableExample-tabpane-accept'] div[id='droppable']")
    DROPPED_TEXT_ACCEPT_SECTION = (By.CSS_SELECTOR, "div[id='droppableExample-tabpane-accept'] div[id='droppable'] p")
    ...
    DRAG_ME_SECTION_PROPOGATION = (By.CSS_SELECTOR, "div[id='dragBox']")
